...
{
    public class UserGroupRoleLinkConfiguration : IEntityTypeConfiguration<UserGroupRoleLink>
    {
        public void Configure(EntityTypeBuilder<UserGroupRoleLink> builder)
        {
